...
for author, url in zip(authors, urls):
	title, num_likes, num_stocks = extract_info(url)
	qiita_info_dic[url] = [
		author,
		title,
		num_likes,
...
df.columns = ['URL','投稿者','タイトル','いいね数','ストック数']
